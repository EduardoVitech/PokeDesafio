...
class DetailsFirePage extends StatefulWidget {
  @override
  State<DetailsFirePage> createState() => _DetailsFirePageState();
}

class _DetailsFirePageState extends State<DetailsFirePage> {
  @override
            ...
            child: Row(
              children: <Widget>[
                ...
                Container(
                  ...
                  child:
                      Image.asset("lib/assets/imagePoke/pk2-2.png", scale: 3.5),
                ),
              ],
            ),
          ),
